...
class HTransformerRecipeEmbedding(nn.Module):
    ...
    def forward_ingrs_instrs(self, ingrs_out=None, instrs_out=None, titles_out=None):
        if self.cross_decoder_recipe:
            ...
            if self.avg_concat and self.get_tokens_cross:
                ...
                x2 = fusion_out[1]
                if self.get_tokens_sep:
                    #print("networks.py line 226")
                    #print(x1.shape)
                    #print(x2.shape)
                    #print(fusion_out[2][0].shape)
                    #print(fusion_out[2][1].shape)
                    #print(fusion_out[2][2].shape)
    ...
    def forward(self, recipe):
        ...
        #print(x[2][2].shape)
        #print('non fusion')
        #print(titles_out.shape)
        #print(ingrs_out.shape)
        #print(instrs_out.shape)
        #return x, titles_out, ingrs_out, instrs_out
        return x, x[2][0], x[2][1], x[2][2]
